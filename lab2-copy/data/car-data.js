...
let data = {
  ...
  "Auda": [
    { "name": "A3", "image": "img/a3.png", "color": "Black", "power": "110 HP", "price": "19999" },
...
// Pretvaranje u niz s ID-evima i nazivima
let categories = Object.entries(data).map(([name, products], index) => ({
  id: index + 1,
  name,
  products: products.map((p, i) => ({
    id: `${name}_${i + 1}`, // generirani jedinstveni ID
    ...p
  }))
}));
